...
object Manual extends App with Shared {
  ...
  val meta = Meta(
    date = DateTime.now(),
    title = "FPNet User Manual v" + BuildInfo.version,
    author = "Tim Nieradzik",
    affiliation = "MetaStack Sp. z o.o.",
    `abstract` = "Neural networks for Scala and Scala.js",
    language = "en-GB",
    url = "",
    editSourceURL = Some("https://github.com/MetaStack-pl/FPNet/edit/master/"))
